      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold mb-4">Política de Troca</h1>
          ...
          <Card className="mb-8">
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  Além disso, {store.store_name} oferece um prazo estendido de <strong>30 dias</strong> 
                  ...
                  <CardContent className="pt-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          {replacePlaceholders(step.description, store)}
                        </p>
                      </div>
                    </div>
                  </CardContent>
          ...
          <Card className="mb-8">
            ...
            <CardContent>
              <div className="space-y-4">
                <div>
                  <h4 className="font-semibold mb-2">Produtos Não Trocáveis:</h4>
