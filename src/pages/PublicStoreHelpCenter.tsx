        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {contactOptions.filter(opt => opt.available).map((option, index) => (
                <Card key={index} className="text-center hover:shadow-lg transition-shadow">
                  <CardContent className="pt-6">
                    ...
                    <Button 
                      ...
                      className="w-full"
                      onClick={option.icon === MessageCircle ? handleWhatsAppClick : undefined}
                      asChild={option.icon !== MessageCircle}
                    >
                      {option.icon === MessageCircle ? (
                        <span>{option.action}</span>
                      ) : option.icon === Mail ? (
                        <a href={`mailto:${store.contact_email}`}>{option.action}</a>
                      ) : (
                        <a href={`tel:${store.contact_phone}`}>{option.action}</a>
                      )}
                    </Button>
                  </CardContent>
                </Card>
